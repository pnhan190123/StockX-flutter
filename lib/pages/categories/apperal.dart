...
class AppreralPage extends StatefulWidget {
  const AppreralPage({Key? key}) : super(key: key);

  @override
  State<AppreralPage> createState() => _AppreralPageState();
}

class _AppreralPageState extends State<AppreralPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream:
            FirebaseFirestore.instance.collection('appreralPage').snapshots(),
